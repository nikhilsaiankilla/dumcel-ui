...
export const DeploymentColumns: ColumnDef<DeploymentType>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return <Link href={`https://${subDomain}.nikhilsaiankilla.blog/`} target="_blank" className='flex items-center gap-2 text-gray-300/60 hover:text-white transition-all duration-150 ease-in-out'>
