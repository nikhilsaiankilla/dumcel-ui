            ...
            <div className='w-full flex items-center justify-between flex-wrap gap-3'>
                <div className='flex items-center gap-3'>
                    ...
                    <div className='flex flex-col space-y-1'>
                        ...
                        <Link href={`https://${project.subDomain}.nikhilsaiankilla.blog/`} target='_blank' className="text-sm text-muted-foreground">{`https://${project.subDomain}.d.nikhilsaiankilla.blog/`}</Link>
                    </div>
                </div>
